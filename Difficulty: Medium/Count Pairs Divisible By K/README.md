<h2><a href="https://www.geeksforgeeks.org/problems/count-pairs-in-array-divisible-by-k/1?_gl=1*xawlm6*_up*MQ..*_gs*MQ..&gclid=Cj0KCQjwjb3SBhDgARIsAMKiWzha8xPKf79Zc0SuOkXIHOjo_FoSW9poMM2dOutRtdm-cTVnSXB7uIoaAiZLEALw_wcB&gbraid=0AAAAAC9yBkDVNPnw8LuLNBDfy6i6Poglz">Count Pairs Divisible By K</a></h2><h3>Difficulty Level : Difficulty: Medium</h3><hr><div class="problems_problem_content__Xm_eO" style="--text-color: var(--problem-text-color);"><p><span style="font-size: 18px;">Given an array <strong>arr[] </strong>and positive integer <strong>k</strong>, count total number of pairs in the array whose sum is divisible by <strong>k</strong>.</span></p>
